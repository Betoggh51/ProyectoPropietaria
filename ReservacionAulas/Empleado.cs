...
namespace ReservacionAulas
{
    public partial class Empleado : MetroFramework.Forms.MetroForm
    {
        ...
        string path = @"\Users\betog\OneDrive\Desktop\Algoritmos\C#\propietaria\ProyectoProp\empleado.csv";
        public Empleado()
        {
            InitializeComponent();
        }
        ...
        {
            writeFileHeader("sep=,");
            writeFileLine("Identificador, Nombre, Cedula, Tanda Laboral, Fecha Ingreso, Estado");
